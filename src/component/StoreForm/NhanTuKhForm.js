...
class NhanTuKhForm extends Component {
        ...
        return (
            <form>
                <div className="modal-header text-center">
                    <h4 className="modal-title w-100 font-weight-bold">NHẬN SẢN PHẨM TỪ KHÁCH HÀNG</h4>
                    <button
                        type="button"
                ...
                <div className="modal-footer d-flex justify-content-center">
                    <button className="btn btn-default" onClick={this.callApiNhanTuKh}>ADD</button>
                </div>
            </form>
        );
    }
