...
export default function PersonList() {
  ...
  const [PersonList, setPersonList] = useState([])
    ...
    function refreshPersonList() {
      const ProjectAPI = axios.get('http://localhost/thule3/ProductionMove/public/api/admin/view_all_products')
    ...
    const [post, setPost] = useState([]);
      ...
      useEffect(() => {
        axios.get(`http://localhost/thule3/ProductionMove/public/api/admin/view_product/${idb}`)
          .then(response => {
