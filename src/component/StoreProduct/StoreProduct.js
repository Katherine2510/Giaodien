...
export default function StoreProduct() {
    ...
    function refreshStoreProduct() {
        const ProjectAPI = axios
            .get(
                `http://localhost/ProductionMove/ProductionMove/public/api/store/view_products/${idb}`
            )
            .then((res) => setStoreProduct(res.data))
